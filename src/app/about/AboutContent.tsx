...
interface AboutContentProps {
  ...
  authors: Array<{ id: string; name: string; slug: string; bio: string; avatar: string; role: string }>
}

export function AboutContent({ categories, authors }: AboutContentProps) {
