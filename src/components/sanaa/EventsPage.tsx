    ...
    <main className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
      ...
      <section className="mb-8 flex flex-wrap items-center gap-3">
        ...
        <Button
          ...
          className="font-mono text-xs h-7 ml-auto"
        >
      ...
      <section className="mb-10">
        <h2 className="font-serif text-xl font-bold mb-4">
          Upcoming Events
          <span className="text-muted-foreground font-mono text-sm font-normal ml-3">
            ({upcoming.length})
          </span>
        </h2>
              ...
              <div className="flex-1 min-w-0">
                ...
                {event.ticketUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-[10px] text-primary font-mono mt-2 hover:underline"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {past.map(event => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-serif font-semibold text-sm text-muted-foreground group-hover:text-foreground transition-colors line-clamp-1">
                    {event.title}
                  </h3>
      ...
      {filtered.length === 0 && (
        <div className="text-center py-16">
          ...
          <Button variant="outline" onClick={() => { setCatFilter('all'); setCityFilter('all'); setShowPast(false) }} className="mt-4 font-mono text-xs">
            Clear Filters
          </Button>
        </div>
      )}
