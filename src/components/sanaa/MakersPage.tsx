...
import { MapPin, Globe, Instagram, Twitter, ArrowLeft } from 'lucide-react'
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
      ...
      <nav className="flex items-center gap-2 text-xs font-mono text-muted-foreground mb-8">
        <button onClick={() => useStore.getState().goHome()} className="hover:text-foreground transition-colors flex items-center gap-1">
              ...
              <ScrollReveal key={maker.id}>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground mt-4 leading-relaxed line-clamp-3">{maker.bio}</p>
